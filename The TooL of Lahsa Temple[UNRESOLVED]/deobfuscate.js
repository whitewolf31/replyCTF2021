...
(function (_0x55c1eb, _0x493846) {
    var _0x51ec84 = _0x213e,
        _0x42dcaf = _0x55c1eb();
    while (!![]) {
        try {
            var _0x4b45b0 = parseInt(_0x51ec84(0x1ae)) / 0x1 * (-parseInt(_0x51ec84(0x19e)) / 0x2) + parseInt(_0x51ec84(0x1a1)) / 0x3 + -parseInt(_0x51ec84(0x1a3)) / 0x4 * (parseInt(_0x51ec84(0x1b7)) / 0x5) + parseInt(_0x51ec84(0x1bc)) / 0x6 * (parseInt(_0x51ec84(0x1ad)) / 0x7) + -parseInt(_0x51ec84(0x19c)) / 0x8 * (-parseInt(_0x51ec84(0x1b3)) / 0x9) + -parseInt(_0x51ec84(0x1af)) / 0xa * (parseInt(_0x51ec84(0x1ac)) / 0xb) + -parseInt(_0x51ec84(0x19d)) / 0xc;
...
function validatekey() {
    ...
    try {
        ...
        _0x38c7c3 = !![];
    } !e ? document['location']['href'][_0x2f306b(0x1a6)](_0x2f306b(0x1b2)) == -0x1 && (document['getElementById'](_0x2f306b(0x19a))[_0x2f306b(0x1a7)] = 'You are Amazing, now you can retrieve the secret file remember to add extension txt') : document['getElementById'](_0x2f306b(0x19a))['innerHTML'] = _0x2f306b(0x1bb);
}
